        ...
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-muted-foreground">Farmers who have purchased from your shop</p>
                </div>
                <div className="bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-100">
                    <span className="font-bold text-lg text-foreground">{customers.length}</span>
                    <span className="text-muted-foreground text-sm ml-2">Total Farmers</span>
                </div>
            </div>
                                    ...
                                    customers.map((customer) => (
                                        <tr key={customer.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                <span className="bg-gray-100 px-2 py-1 rounded-md text-xs font-medium text-muted-foreground">

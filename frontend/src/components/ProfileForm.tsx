                        ...
                        <div className="flex-1 space-y-4 w-full">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input ref={fatherRef} defaultValue={initialData?.father_name || initialData?.father_husband_name} required className="w-full border-2 rounded-xl p-2.5 bg-background text-foreground focus:border-primary outline-none" />
                                </div>
                                {(role === 'mill' || role === 'shop') && (
